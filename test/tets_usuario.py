import pytest
from Perfil_usuario_2 import crear_perfil, obtener_estadisticas_perfil, extraer_datos_perfil
...
# --- Pruebas para crear_perfil (Validaciones) ---

def test_nombre_vacio_lanza_error():
    """Test que verifica que nombre vacío lanza ValueError."""
...
# --- Pruebas para crear_perfil (Casos Extremos y Generales) ---
...
def test_red_social_con_guion_bajo():
    ...
    # Nota: Depende de cómo maneje 'crear_perfil' la clave (ej: 'red_social_personalizada' -> 'Red Social Personalizada')
...
# --- Pruebas para obtener_estadisticas_perfil ---
...
def test_estadisticas_basicas():
    ...
    assert stats["edad"] == 30

def test_estadisticas_con_hobbies():
    """Test estadísticas con hobbies."""
    stats = obtener_estadisticas_perfil("María", 25, "lectura", "yoga")
    assert stats["cantidad_hobbies"] == 2

def test_estadisticas_con_redes():
    """Test estadísticas con redes sociales."""
    stats = obtener_estadisticas_perfil("Carlos", 28, instagram="@carlos", twitter="@carlos")
    assert stats["cantidad_redes"] == 2


# --- Pruebas para extraer_datos_perfil ---

def test_extraer_datos_basicos():
    """Test extracción de datos básicos."""
    nombre, edad, hobbies, redes = extraer_datos_perfil("Juan", 30)
    assert nombre == "Juan"
    assert edad == 30
...
def test_extraer_con_redes():
    ...
    nombre, edad, hobbies, redes = extraer_datos_perfil("Carlos", 28, twitter="@carlos", github="carlos")
