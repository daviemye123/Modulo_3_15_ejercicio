...
def obtener_estadisticas_perfil(
    nombre: str, edad: int, *hobbies: str, **redes_sociales: str
) -> Dict[str, int]:
    """
...
def extraer_datos_perfil(
    nombre: str, edad: int, *hobbies: str, **redes_sociales: str
) -> Tuple[str, int, Tuple[str, ...], Dict[str, str]]:
    """
...
if __name__ == "__main__":
    ...
    print()
    perfil3 = crear_perfil("Yamith Rosas", 19, "voley", "senderismo", "pintura")
    print(perfil3)
